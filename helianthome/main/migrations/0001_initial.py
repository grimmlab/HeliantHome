# Generated by Django 3.2.4 on 2021-06-18 08:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AlternativeAccession',
            fields=[
                ('alt_acc_id', models.CharField(db_index=True, max_length=20, primary_key=True, serialize=False)),
                ('alt_acc_name', models.CharField(blank=True, max_length=20, null=True)),
                ('accession', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.accession')),
            ],
        ),
        migrations.AddField(
